...
#define FORALL_ALLOCATOR_INTERFACE(_)                                          \
  ...
  _(C10_CUDA_API void, setContextRecorder, (CreateContextFn recorder))
...
inline void setContextRecorder(CreateContextFn recorder) {
  return Chosen::setContextRecorder(recorder);
}
